...
export const Default = {
  args: {
    ...
    onDeleteMember: (memberId) => console.log('Delete member:', memberId),
...
export const WithManyMembers = {
  args: {
    members: Array(20).fill(null).map((_, index) => ({
      ...
      isCoach: index % 5 === 0,
      isActive: index % 3 !== 0,
      lastCheckIn: new Date(Date.now() - (index * 24 * 60 * 60 * 1000)).toISOString(),
      membershipExpiry: new Date(Date.now() + ((index - 10) * 24 * 60 * 60 * 1000)).toISOString(),
    })),
    onUpdateMember: (member) => console.log('Update member:', member),
    onDeleteMember: (memberId) => console.log('Delete member:', memberId),
    onAddMember: (member) => console.log('Add member:', member),
